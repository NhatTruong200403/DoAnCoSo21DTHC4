    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarTypesDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarTypesDetails_CarTypes_CarTypeId",
                        column: x => x.CarTypeId,
                        principalTable: "CarTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarTypesDetails_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarTypesDetails_CarTypeId",
                table: "CarTypesDetails",
                column: "CarTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CarTypesDetails_CompanyId",
                table: "CarTypesDetails",
                column: "CompanyId");
